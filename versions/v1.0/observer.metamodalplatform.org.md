...
\- \*\*E (Terrestrial):\*\* h=0; variables (x,y,z,t; v; g; μ\_surface). Constraint: static vs kinetic μ (friction law).
...
\- Initial weight penalty w\_anonymous = α·w\_identified (α<1); can earn weight via consistency over time.
